...
\033[1;94m##:::. ##:'####: ##:::: ##: ########:
\033[1;94m..:::::..::....::..:::::..::........::
\033[37;1m[\033[41;1m RIAZ KHAN_____/___/_\ \033[00;1m\033[37;1m ]\n
\033[1;37;40m┌──────────────────────┐
\033[1;37;40m│ ®꧁꧂꧁꧂RIAZ  ꧁꧂꧁꧂ ® |
\033[1;37;40m└──────────────────────┘
\033[37;1m[\033[41;1m ꧁꧂꧁꧂HACKER  ꧁꧂꧁꧂ \033[00;1m\033[37;1m ]\n
\033[32;1mVersion\033[37;1m:\033[33;1m1.0""")

host="https://www.facebook.com/Riaz-hacker-100835532473815/"
ips=None
try:
...
class crack:
	...
	def main(self,fl):
		try:
			...
			self.ko+=1
			print("\r\x1b[0;33mCrack %s/%s OK : %s CP : %s"%(self.ko,len(self.fl),len(self.ada),len(self.cp)), end=' ');sys.stdout.flush()
		except:
			self.main(fl)
